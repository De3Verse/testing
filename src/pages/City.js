...
export default function City() {
  ...
  const { unityProvider, loadingProgression, isLoaded } = useUnityContext({
    loaderUrl: `${process.env.REACT_APP_BASE_URL}/city/loader.js`,
    dataUrl: `${process.env.REACT_APP_BASE_URL}/city/data`,
    frameworkUrl: `${process.env.REACT_APP_BASE_URL}/city/framework.js`,
    codeUrl: `${process.env.REACT_APP_BASE_URL}/city/wasm`,
  });
